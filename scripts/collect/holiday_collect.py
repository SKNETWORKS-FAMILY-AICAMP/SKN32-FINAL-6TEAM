...
# 출력: final_project_cs/app/modules/travel_ops/mobility_engine/rules/holidays_<시작>_<끝>.json — git 에 둔다(연 단위로만 바뀌고 팀원도 쓴다).
...
OUT_DIR = REPO / "final_project_cs" / "app" / "modules" / "travel_ops" / "mobility_engine" / "rules"
